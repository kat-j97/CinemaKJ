...
public class CarritoController {
    ...
    @GetMapping("/carrito/agregar/{idComida}")
    public ModelAndView agregarItem(Model model, Item item) {
        Item item2 = itemService.get(item);
        if (item2 == null) {
            Comida comida = comidaService.getComida(item);
            item2 = new Item(comida);
        }
    ...
    @GetMapping("/carrito/modificar/{idComida}")
    ...
    @GetMapping("/carrito/eliminar/{idComida}")
